...
const EmployeesPage: React.FC = () => {
  ...
  const { filteredEmployees, employees, isLoading, error, refreshEmployees } = useEmployees();
    ...
    try {
      ...
      const csvContent = [
        ...
        ...employees.map(emp => [
          ...
          new Date(emp.start_date).toLocaleDateString('pt-BR')
        ])
      ...
      <div className="space-y-6">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">Carregando colaboradores...</p>
          </div>
        </div>
