...
import { CreateSystemUserData, UpdateSystemUserData } from '@/types/systemUser';

interface UserFormProps {
  form: UseFormReturn<CreateSystemUserData | UpdateSystemUserData>;
  isEdit?: boolean;
}
...
export const UserForm: React.FC<UserFormProps> = ({ form, isEdit = false }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Credenciais - apenas para novo usuário */}
      {!isEdit && (
        <div className="space-y-4">
