...
import { Star, CheckCircle, FileText, Award } from 'lucide-react';
              ...
              <CardHeader>
                <CardTitle className="flex items-center justify-between">
                  ...
                  <Badge variant="outline">
                    {totalCalculatedStars} / {program.totalPossibleStars} ⭐
                  </Badge>
                </CardTitle>
              </CardHeader>
              <CardContent>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    ...
                    <div className="text-sm text-gray-600">
                      de {program.totalPossibleStars} possíveis
                    </div>
                  </div>
                </div>
              </CardContent>
