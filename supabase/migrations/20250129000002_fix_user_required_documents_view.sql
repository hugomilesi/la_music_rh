-- Migração: Corrigir view user_required_documents para resolver problemas de relacionamento
-- Data: 2025-01-29
-- Descrição: Corrigir JOINs e garantir que colaboradores com documentos sejam exibidos corretamente

-- Remover a view existente
DROP VIEW IF EXISTS public.user_required_documents;

-- Recriar a view com lógica corrigida
